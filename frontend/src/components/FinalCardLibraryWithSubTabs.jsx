...
import { Folder, Plus, Search, MoreVertical, Hand, FolderOpen, Users, Package, Shield, Upload, Eye } from "lucide-react";
import { useToast } from "../hooks/use-toast";
import EnhancedDeckDetailView from "./EnhancedDeckDetailView";
import DeckSearchTab from "./DeckSearchTab";

const FinalCardLibraryWithSubTabs = ({ 
  cards, 
  folders, 
  sleeves, 
  onAddFolder, 
  ...
  if (viewingDeck) {
    return (
      <EnhancedDeckDetailView 
        ...
        onRemoveCardFromDeck={(deckId, cardId, quantity) => {
          onRemoveCardFromDeck(deckId, cardId, quantity);
          // Update viewing deck to reflect changes
          const updatedDeck = folders.find(f => f.id === deckId);
          if (updatedDeck) {
            setViewingDeck(updatedDeck);
          }
        }}
    ...
    <div className="max-w-6xl mx-auto">
      ...
      <Tabs defaultValue="browse" className="h-full">
        <TabsList className="grid w-full grid-cols-3 bg-slate-800 border border-slate-700">
          ...
          <TabsTrigger value="sleeves" className="flex items-center gap-2">
...
export default FinalCardLibraryWithSubTabs;